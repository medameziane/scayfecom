...
<!-- Start products -->
<div class="wrrapper">
    <div class="sidebar-title-daily">Recommended for you</div>
...
<div class="wrrapper">
    <div class="sidebar-title-daily">Popular categories</div>
...
<div class="wrrapper">
    <section class="product-columns">
        ...
        <div class="product-column">
            <div class="sidebar-title">Best Seller</div>
        ...
        <div class="product-column">
            <div class="sidebar-title">Products for you</div>
        ...
        <div class="product-column">
            <div class="sidebar-title">Hot now</div>
...
<div class="wrrapper">
    <div class="featured-categories">
        <div class="featured-header flexing">
            <p class="featured-header-title">Featured Categories</p>
